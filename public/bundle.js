...
For more info, visit https://fb.me/react-mock-scheduler`);
  ...
  const PropTypes = __toModule(require_prop_types());
  ...
  const PropTypes2 = __toModule(require_prop_types());
  class VideoList extends React3.Component {
    static propTypes = {
      videos: PropTypes2.arrayOf(PropTypes2.shape({
        title: PropTypes2.string.isRequired,
        description: PropTypes2.string.isRequired,
