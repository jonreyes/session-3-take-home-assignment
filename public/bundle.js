...
For more info, visit https://fb.me/react-mock-scheduler`);
  ...
  // src/constants.js
  const constants_default = videosList = [
    {
      title: "Hello",
  ...
  // src/utilities.js
  const utilities_default = getVideoIdFromPageUrl = (url) => {
    let items = url.split("/");
  ...
  class VideoButton extends React2.Component {
    ...
    render() {
      ...
      }, React2.createElement("h4", null, video.videoTitle), React2.createElement("p", null, video.videoDescription)));
    }
  }
  ...
  class VideoList extends React3.Component {
    ...
    render() {
      ...
      }, videos.map(({title, description, img, url}, index) => {
        const id = utilities_default(url);
  ...
  class VideoPlayer2 extends React4.Component {
    ...
    render() {
      var videos = constants_default;
      var id = utilities_default(videos[this.state.selected].url);
